...
[![docker size](https://img.shields.io/docker/image-size/rongyunmu/mediahelp/latest?logo=docker&&logoColor=white)](https://hub.docker.com/r/rongyunmu/mediahelp)
[![docker pull](https://img.shields.io/docker/pulls/rongyunmu/mediahelp?logo=docker&&logoColor=white)](https://hub.docker.com/r/rongyunmu/mediahelp)
...
- 🔍 **智能资源搜索**
  - 集成 TG 频道资源搜索、pansou、以及nullbr搜索
  - 支持动态配置搜索参数
  - 快速定位所需资源
  - 支持豆瓣电影推荐

- 📱 **多网盘支持**
  - 支持天翼云盘、夸克网盘、UC网盘、115网盘
  - 统一管理界面
  - 一键转存功能
